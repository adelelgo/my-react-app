...
import img11 from "../assets/images/logo-dark.svg";
import img22 from "../assets/images/logo-light.svg";

// import js1 from "./js/tiny-slider.js";
// import js2 from "./js/typewriter.js";
// import js3 from "./js/isotope.min.js";
// import js4 from "./js/wow.min.js";
// import js5 from "./js/main.js";
// import js6 from "./js/menu.js";
...
function Footer() {
  return (
    <>
              ...
              <div className="a1U">
                ...
                <ul className="a1Z">
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="aE aF aG hover:aH dark:hover:aI"
                    >
                      Home
                    </a>
                  </li>
              ...
              <div className="a1U">
                ...
                <form className="ac">
                  <input
                    ...
                    className="a24 a4 aS aT a17 a25 a26 aF aG a27 focus:a28 dark:aZ dark:a_[#2C3443]"
                  />
                  <button className="a1 a29 a2 a5 a2a a2b a9 am a2c aG dark:a1z[#1F2633]">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
            ...
            <div className="a1R a5 a6 a2e md:a2f">
              <div className="a4 a1v md:a1S/2 lg:a1W/3">
                <div className="a1I a5 a9 am a12 a1x aV dark:a1z[#2E333D] md:a2g md:as md:a2h md:a2i">
                  <a href="javascript:void(0)" className="aE aF aG hover:aH">
                    English
                  </a>
                  <a href="javascript:void(0)" className="aE aF aG hover:aH">
                    Privacy Policy
      ...
      <a
        href="#home"
        class="hover:a2k back-to-top aj a2l a2m a2n ad[999] ag a2o a2p a9 am a2q a16 aI a2r aN"
        style={{ display: "flex" }}
      >
        <span class="a2s[6px] a2t a1T a2u a2d a2c a2v"></span>
      </a>

      {/* <script src={require("../assets/js/tiny-slider.js")}></script> */}
