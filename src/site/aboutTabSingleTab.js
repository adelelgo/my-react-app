...
function AboutTabSingleTab({ data }) {
  return (
    <>
      <div className="a1R a5 a6 a9 a1u[70px]">
        <div className="a4 a1v lg:a1S/2">
          <div className="ac a3h a2O ah[490px] ae[600px] lg:a2g">
            <div className="a1 a3 a2">
              {/* <img src={image4} alt="about-image" /> */}
              <img src={data.image1} alt="about-image" />
            </div>
            <div className="a1 a29 a1a/2 a2w a1c/2">
              {/* <img src={image5} alt="about-image" /> */}
              <img src={data.image2} alt="about-image" />
              <div className="a1 a3z a3A a2D a2a a4 aT a28 a3l a16 a3b a3m[6px] dark:a2v dark:a3l dark:an dark:a3c"></div>
            </div>
        ...
        <div className="a4 a1v lg:a1S/2">
          <div className="max-w-[565px] lg:a3C">
            <h2 className="a1E aE a1Y a3D a1t dark:aI sm:a1F[40px] sm:a3f[50px]">
              {/* 1 - We are Creative Digital Agency Based in USA */}
              {data.title}
            </h2>
...
export default AboutTabSingleTab;
