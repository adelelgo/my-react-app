...
function Home() {
  return (
    <>
      <section
        id="home"
        className="ac a36 a2T a37 a38 sm:a39 lg:a1u[170px] lg:a1A[120px]"
      >
        <div className="a1v xl:a1w">
          <div className="a1R a5 a6 a9">
            <div className="a4 a35 lg:a1S/2">
              <div className="a1B a2J ae[530px] az lg:a3a lg:a2g lg:aW">
                <span
                  className="wow fadeInUp a1E af a1j a16 a3b a1N[10px] a7 aE aF aH dark:an dark:a3c dark:aI"
                  data-wow-delay=".2s"
                  style={{
                    visibility: "visible",
                    animationDelay: "0.2s",
                ...
                >
                  <span className="a3d af a3e a1W a1j a16"></span>
                  Tailwind Template for Startups
                </span>
                <h1
                  className="wow fadeInUp a1I aE a1Y a1G dark:aI sm:a1L md:a1F[50px] md:a3f[60px]"
                  data-wow-delay=".3s"
                  style={{
                    visibility: "visible",
                    animationDelay: "0.3s",
                ...
                <p
                  className="wow fadeInUp a2J aF aG"
                  data-wow-delay=".4s"
                  style={{
                    visibility: "visible",
                    animationDelay: "0.4s",
                ...
                <div
                  className="wow fadeInUp a5 a6 a9 am lg:as"
                  data-wow-delay=".5s"
                  style={{
                    visibility: "visible",
                    animationDelay: "0.5s",
                ...
                >
                  ...
                  <a
                    href="#about"
                    className="aD a9 aS a1N[14px] aU aE aF a1t hover:aH dark:aI dark:hover:aH"
                  >
                    <span className="a2H">
                      <svg
                        width="24"
            ...
            <div className="a4 a1v lg:a1S/2">
              <div
                className="wow fadeInRight ac a3h a1B ah[560px] a4 ae[700px] lg:a3a"
                data-wow-delay=".3s"
                style={{
                  visibility: "visible",
                  animationDelay: "0.3s",
        ...
        <div
          className="a1 a10 a3 a2D a2a a4 a2x a2y a3n dark:a3o"
          style={{ backgroundImage: "url(" + ctaBacground + ")" }}
        ></div>
        <div className="a1 a2 a29 a2D">
          <svg
            width="1356"
            height="860"
