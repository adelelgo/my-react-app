            ...
            <div className="a4 a1v xl:a2p/12">
              <div className="a5 a6 a9 a1x a4b dark:a1z[#2E333D] lg:a2i">
                <div className="a4 a1v lg:a1S/2">
                  <div
                    className="wow fadeInUp ac a2J ae[500px] a1C md:a2O lg:a3p"
                    data-wow-delay=".2s"
                    style={{
                      visibility: "visible",
                      animationDelay: "0.2s",
                  ...
                  >
                    ...
                    <h2 className="a1I aE a1J a1G a1t dark:aI sm:a1L md:a1F[50px] md:a3f[60px]">
                ...
                <div className="a4 a1v lg:a1S/2">
                  ...
                  >
                    ...
                    <a
                      ...
                      className="aE a2Z a1t dark:aI md:a1J lg:a2Z xl:a1J"
                    >
                      info@gostartup.com
                    </a>
                  </div>
              ...
              <div
                className="wow fadeInUp a1R a5 a6 a2K"
                data-wow-delay=".2s"
                style={{
                  visibility: "visible",
                  animationDelay: "0.2s",
              ...
              >
                <div className="a4 a1v md:a1S/2 lg:a1S/4">
                  <div className="a1V">
                    <h3 className="a44 aE aF a1t dark:aI sm:a2Z">
                      Email Address
                    </h3>
                    <p className="aF a1K aG">support@startup.com</p>
                  </div>
                </div>
                <div className="a4 a1v md:a1S/2 lg:a1S/4">
                  <div className="a1V">
            ...
            >
              <div className="a1R a5 a6">
                <div className="a4 a1v sm:a1S/2">
                  <div className="a2J">
                    <label for="name" className="a3s ai aE aF a1t dark:aI">
                      Your Name
                    </label>
                    <input
                      type="text"
                ...
                <div className="a4 a1v sm:a1S/2">
                  <div className="a2J">
                    <label for="email" className="a3s ai aE aF a1t dark:aI">
                      Email Address
                    </label>
                    <input
                      type="email"
                ...
                <div className="a4 a1v sm:a1S/2">
                  <div className="a2J">
                    <label for="phone" className="a3s ai aE aF a1t dark:aI">
                      Phone (Optional)
                    </label>
                    <input
                      type="text"
                ...
                <div className="a4 a1v sm:a1S/2">
                  <div className="a2J">
                    <label for="subject" className="a3s ai aE aF a1t dark:aI">
                      Subject
                    </label>
                    <input
                      type="text"
                ...
                <div className="a4 a1v">
                  <div className="a1M">
                    <label for="message" className="a3s ai aE aF a1t dark:aI">
                      Message
                    </label>
                    <textarea
                      rows="4"
                      ...
                      className="a4 a2Q a1x at a2e aF a1K a1t a2P a27 focus:a28 dark:a1z[#2C3443] dark:aI dark:focus:a2v"
                    ></textarea>
                  </div>
                </div>
                <div className="a4 a1v">
